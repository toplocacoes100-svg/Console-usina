    ...
    (async () => {
     try {
      ...
      lastSyncedRef.current = {
        ...
        [STORAGE_KEYS.producaoPerf]: JSON.stringify(pp),
        ...
        [STORAGE_KEYS.fotosIndex]: JSON.stringify(ft),
        [STORAGE_KEYS.agenda]: JSON.stringify(ag),
        [STORAGE_KEYS.ticks]: JSON.stringify(tk),
        ...
        [STORAGE_KEYS.checklists]: JSON.stringify(ck),
        ...
        [STORAGE_KEYS.estacas]: JSON.stringify(es),
